...
public class OrderTrackCommandHandler {
    ...
    TrackOrderResponse trackOrder(TrackOrderQuery trackOrderQuery) {
        var result = orderRepository.findByTrackingId(new TrackingId(trackOrderQuery.getOrderTrackingId()));
        if (result.isEmpty()) {
        ...
        return orderDataMapper.orderToTrackOrderResponse(result.get());
    }
}
